    ...
    <section className="w-full lg">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center overflow-hidden lg:grid-cols-2">
        ...
        <div className="px-3 py-10 sm:px-10 md:py-20 lg:px-12 lg:py-30">
          ...
          <div className="flex gap-x-12 mt-10 items-center">
            {/* Post button */}
            <button
              onClick={() => {
                router.push("/post");
              }}
              className="flex gap-x-2 bg-blue-600 text-white px-2 py-2 hover:cursor-pointer hover:bg-blue-400 rounded-md"
            >
            ...
            <button
              ...
              className="bg-black text-white px-3 py-2 hover:cursor-pointer hover:bg-gray-700 rounded-md"
            >
              Browse Items
            </button>
          </div>
